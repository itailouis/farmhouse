...
public class BuyerFragment extends Fragment {
    private final static String TAG = BuyerFragment.class.getName();
    ...
    public void updateDisplay(){
        if(data.isEmpty()){
            adapter = new BuyersAdapter(getActivity(),data);
            listview.setAdapter(adapter);
        }else{
    ...
    public void getJsonObect(){
        ...
        CustomRequest req = new CustomRequest(Request.Method.GET, String.format(EndPoint.BUYER_URL,ip),
                null ,
                        ...
                        try {
                            ...
                            if(error==0){
                              ...
                              for (int i =0;i<buy.length();i++ ) {
                                    ...
                                    buyer.setBrefMassage(buyOB.getString("BrifeTerms"));
                                    buyer.setQuantity(buyOB.getDouble("tones"));
                                    buyer.setCropName(buyOB.getString("CropName"));
