...
public class NavDrawer {
    ...
    public NavDrawer(BaseActivity activity) {
        ...
        if (drawerLayout == null || navDrawerView == null)
            throw new RuntimeException("You must have ids for drawer_layout and nav_drawer");
    ...
    public static class BasicNavDrawerItem extends NavDrawerItem implements View.OnClickListener {
        ...
        private TextView textView, badgeTextView;
        private View view;
        ...
        public void inflate(LayoutInflater inflater, ViewGroup navDrawerView) {
            ...
            if (container == null)
                throw new RuntimeException("Nav drawer item " + text + " could attach to viewGroup. View not found");
    ...
    public static class ActivityNavDrawerItem extends BasicNavDrawerItem {
        ...
        public void onClick(View v) {
            ...
            super.onClick(v);
            // If we are in the same activity then navigation drawer will close because we are already on that activity
            ...
            //When the fade out animation end then other activity start
